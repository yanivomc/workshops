...
ADD . ./
RUN wget https://jb-workshop.s3-eu-west-1.amazonaws.com/terraform-provider-aws_v2.39.0_x4 -O .terraform.d/plugin-cache/linux_amd64/terraform-provider-aws_v2.39.0_x4
